...
export function Button({
  ...
  const base =
    ...
    "transition active:scale-[0.99] focus:outline-none focus:ring-4 focus:ring-orange-500/15 " +
    "disabled:opacity-50 disabled:pointer-events-none";

  const variants: Record<string, string> = {
    default:
      "accent-ring bg-orange-500/12 text-orange-200 border border-orange-400/20 " +
      "hover:bg-orange-500/18 hover:text-orange-100",
    outline:
      "border border-white/12 bg-white/5 text-gray-100 " +
      "hover:bg-white/10 hover:border-orange-400/20",
    ghost:
      "text-gray-100 hover:bg-white/7 hover:text-white",
    danger:
